...
final class DashboardI18n {
    ...
    private static Map<String, Map<String, String>> translations() {
        ...
        put(en,
                ...
                "belowDisplayRange", "below the displayed range",
                "aboveDisplayRange", "above the displayed range",
                "lowOutliers", "low outliers",
                "highOutliers", "high outliers",
                "tukeyOutlier", "Tukey outlier",
        ...
        put(ar,
                ...
                "belowDisplayRange", "أدنى من النطاق المعروض",
                "aboveDisplayRange", "أعلى من النطاق المعروض",
                "lowOutliers", "قيم متطرفة منخفضة",
                "highOutliers", "قيم متطرفة مرتفعة",
                "tukeyOutlier", "قيمة توكي متطرفة",
        ...
        put(ur,
                ...
                "belowDisplayRange", "دکھائی گئی حد سے کم",
                "aboveDisplayRange", "دکھائی گئی حد سے زیادہ",
                "lowOutliers", "کم بیرونی قدریں",
                "highOutliers", "زیادہ بیرونی قدریں",
                "tukeyOutlier", "ٹوکی بیرونی قدر",
